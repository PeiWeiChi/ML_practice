...
The accuracy, 0.736, is not good. I affraid it can't predict the test data well 
...
Wow! the accuracy is so high, which is 0.99. But I worry about overfitting in this data set and then have a poor predction in other data set.
